...
type SharedProfile = {
  ...
  role: string;
  memberId?: string;
  profile: { bio: string; skills: string[]; github: string; linkedin: string; twitter: string; avatar: string | null; qr: string | null };
};
